...
func setServiceDefaults(v *viper.Viper, appEnv string) {
	setDefaults(v, map[string]any{
		...
		"logger.opensearch.username":             "",
		"logger.opensearch.password":             "",
		"logger.opensearch.insecure_skip_verify": false,
		"logger.opensearch.flush_interval":       "1s",
		"logger.opensearch.batch_size":           100,
		"logger.opensearch.queue_size":           1000,
		"logger.opensearch.request_timeout":      "5s",
